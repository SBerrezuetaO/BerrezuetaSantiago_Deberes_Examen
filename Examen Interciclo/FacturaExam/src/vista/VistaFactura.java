...
public class VistaFactura {
    ...
    public void crear(){
        ...
        System.out.println("Ingrese la cedula del cliente nuevo: ");
        teclado.nextLine();
        String cedula = teclado.nextLine();
        Cliente cliente = controladorCliente.buscar(cedula);
        if(cliente != null){ 
            while(num1 <= num){
                System.out.println("Ingrese la descripcion del producto a comprar: ");
            ...
            try {
                System.out.println("Res:" + controladorFactura.crear(controladorFactura.generarId(), formatoFecha.parse(fecha), listaProductosCliente, cliente, valor));
